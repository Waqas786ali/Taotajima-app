    ...
    return (
        <div className='text-white  h-screen overflow-hidden relative w-[100wv]'>
            ...
            <Hero
                ...
                dis='hidden'
                currenttext='CITIZEN - ATTESA'
                current='#017 / client work'
                pagenumtext='TELE-PLAY - prism'
                prevpagetext='FUTUERE FOOD TALK'
                pagenum='#018' prevpage='#016'
                para='Directed a promotional video for CITIZEN ATTESA. The theme of the video is black titanium, which is the material of the product, and sponsorship for the lunar exploration program HAKUTO-R.'
            />
            <div className='h-[100vh] bg-cover bg-center cover vidoe fixed object-cover w-[100vw] z-[-2] top-0 left-0'>
                <img className='w-[100%] h-[100%]' src={img4} alt='img2' />
            </div>
            ...
            <div className={`${display === true ? 'end':'start'} video  w-[100vw] h-[100vh] flex justify-center bg-black items-center  top-0 z-30 absolute`}>
                <iframe title="vimeo-player" src="https://player.vimeo.com/video/619860471?h=a29f8be081" width="640" height="360" frameborder="0" allowfullscreen></iframe>
            ...
            <div className={`text-black ${text === true ? 'end' : 'start'} font-mono w-[100vw] absolute  p-4 top-0 h-[100vh] bg-white opacity-[0.95]`}>
                ...
                <div className='px-4 flex flex-col gap-2 mt-8'>
                    <p className='text-xl sm:text-2xl'>#017 / client work</p>
                    <h1 className='text-3xl sm:text-4xl'>CITIZEN - ATTESA</h1>
                    <p className=' sm:w-[600px] xl:w-[900px]'>Directed a promotional video for CITIZEN ATTESA. The theme of the video is black titanium, which is the material of the product, and sponsorship for the lunar exploration program HAKUTO-R.</p>
...
export default transition(Page17);