    ...
    return (
        <div className='text-white  h-screen overflow-hidden relative w-[100wv]'>
            ...
            <Hero
                ...
                dis='hidden'
                currenttext='Cuushe Magic'
                current='#015 / private work'
                pagenumtext='FUTUERE FOOD TALK'
                prevpagetext='Pasocom Music Club - reiji'
                pagenum='#016' prevpage='#014'
                para='Co-directed and produced Cuushe s music video “Magic” with animation artist Yoko Kuno. The video depicts the journey of two girls trying to escape from a spell in a mythical world.'
            />
            ...
            <div className={`text-black ${text === true ? 'end' : 'start'} font-mono w-[100vw] absolute  p-4 top-0 h-[100vh] bg-white opacity-[0.95]`}>
                ...
                <div className='px-4 flex flex-col gap-2 mt-8'>
                    <p className='text-xl sm:text-2xl'>#015 / private work</p>
                    <h1 className='text-3xl sm:text-4xl'>Cuushe Magic</h1>
                    <p className=' sm:w-[600px] xl:w-[900px]'>Co-directed and produced Cuushe s music video “Magic” with animation artist Yoko Kuno. The video depicts the journey of two girls trying to escape from a spell in a mythical world.</p>
...
export default transition(Page15);